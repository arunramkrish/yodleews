 ...
 * 
 */
@WebServiceClient(name = "AddNumbersImplService", targetNamespace = "http://handler.yodlee.com/", wsdlLocation = "http://localhost:8999/handler?wsdl")
@HandlerChain(file = "AddNumbersImplService_handler.xml")
    ...
    extends Service
{
    ...
    private final static QName ADDNUMBERSIMPLSERVICE_QNAME = new QName("http://handler.yodlee.com/", "AddNumbersImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8999/handler?wsdl");
    ...
    public AddNumbersImpl getAddNumbersImplPort() {
        return super.getPort(new QName("http://handler.yodlee.com/", "AddNumbersImplPort"), AddNumbersImpl.class);
    }
    ...
    public AddNumbersImpl getAddNumbersImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://handler.yodlee.com/", "AddNumbersImplPort"), AddNumbersImpl.class, features);
    }
